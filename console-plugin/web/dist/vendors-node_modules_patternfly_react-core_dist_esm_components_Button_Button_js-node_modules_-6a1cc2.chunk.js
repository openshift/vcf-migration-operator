"use strict";
(self["webpackChunkvcf_migration_console"] = self["webpackChunkvcf_migration_console"] || []).push([["vendors-node_modules_patternfly_react-core_dist_esm_components_Button_Button_js-node_modules_-6a1cc2"],{
...
// UNUSED EXPORTS: TooltipPosition
...
const TooltipContent = (_a) => {
    var { className, children, isLeftAligned } = _a, props = (0,tslib_es6/* __rest */.Tt)(_a, ["className", "children", "isLeftAligned"]);
    return (consume_shared_module_default_react_17_0_singleton_.createElement("div", Object.assign({ className: (0,esm/* css */.A)(tooltip.tooltipContent, isLeftAligned && tooltip.modifiers.textAlignLeft, className) }, props), children));
};
...
const TooltipArrow = (_a) => {
    ...
    return consume_shared_module_default_react_17_0_singleton_.createElement("div", Object.assign({ className: (0,esm/* css */.A)(tooltip.tooltipArrow, className) }, props));
};
...
const Tooltip = (_a) => {
    var { content: bodyContent, position = 'top', trigger = 'mouseenter focus', isVisible = false, isContentLeftAligned = false, enableFlip = true, className = '', entryDelay = 300, exitDelay = 300, appendTo = () => document.body, zIndex = 9999, minWidth, maxWidth = esm_c_tooltip_MaxWidth.value, distance = 15, aria = 'describedby', 
    // For every initial starting position, there are 3 escape positions
    flipBehavior = ['top', 'right', 'bottom', 'left', 'top', 'right', 'bottom'], id = `pf-tooltip-${pfTooltipIdCounter++}`, children, animationDuration = 300, triggerRef, 'aria-live': ariaLive = triggerRef ? 'polite' : 'off', onTooltipHidden = () => { } } = _a, rest = (0,tslib_es6/* __rest */.Tt)(_a, ["content", "position", "trigger", "isVisible", "isContentLeftAligned", "enableFlip", "className", "entryDelay", "exitDelay", "appendTo", "zIndex", "minWidth", "maxWidth", "distance", "aria", "flipBehavior", "id", "children", "animationDuration", "triggerRef", 'aria-live', "onTooltipHidden"]);
    ...
    const positionModifiers = {
        top: tooltip.modifiers.top,
        bottom: tooltip.modifiers.bottom,
        left: tooltip.modifiers.left,
        right: tooltip.modifiers.right,
        'top-start': tooltip.modifiers.topLeft,
        'top-end': tooltip.modifiers.topRight,
        'bottom-start': tooltip.modifiers.bottomLeft,
        'bottom-end': tooltip.modifiers.bottomRight,
        'left-start': tooltip.modifiers.leftTop,
        'left-end': tooltip.modifiers.leftBottom,
        'right-start': tooltip.modifiers.rightTop,
        'right-end': tooltip.modifiers.rightBottom
    };
    const hasCustomMaxWidth = maxWidth !== esm_c_tooltip_MaxWidth.value;
    const content = (consume_shared_module_default_react_17_0_singleton_.createElement("div", Object.assign({ "aria-live": ariaLive, className: (0,esm/* css */.A)(tooltip.tooltip, className), role: "tooltip", id: id, style: {
            maxWidth: hasCustomMaxWidth ? maxWidth : null
        }, ref: popperRef }, rest),
        consume_shared_module_default_react_17_0_singleton_.createElement(TooltipArrow, null),
        consume_shared_module_default_react_17_0_singleton_.createElement(TooltipContent, { isLeftAligned: isContentLeftAligned }, bodyContent)));
...
// UNUSED EXPORTS: getOpacityTransition
    ...
    return function createPopper(reference, popper, options = defaultOptions) {
        ...
        const instance = {
            ...
            setOptions(options) {
                ...
                if (false /* __DEV__*/) // removed by dead control flow
{}
                runModifierEffects();
...
const usePopper = (referenceElement, popperElement, options = {}) => {
    const prevOptions = consume_shared_module_default_react_17_0_singleton_.useRef(null);
    ...
    const [state, setState] = consume_shared_module_default_react_17_0_singleton_.useState({
        styles: {
            popper: {
    ...
    const updateStateModifier = consume_shared_module_default_react_17_0_singleton_.useMemo(() => ({
        name: 'updateState',
        enabled: true,
        phase: 'write',
    ...
    const popperOptions = consume_shared_module_default_react_17_0_singleton_.useMemo(() => {
        const newOptions = {
    ...
    const popperInstanceRef = consume_shared_module_default_react_17_0_singleton_.useRef();
...
const Popper = ({ trigger, popper, direction = 'down', position = 'start', placement, width, minWidth = 'trigger', maxWidth, appendTo = 'inline', zIndex = 9999, isVisible = true, positionModifiers, distance = 0, onMouseEnter, onMouseLeave, onFocus, onBlur, onDocumentClick, onTriggerClick, onTriggerEnter, onPopperClick, onPopperMouseEnter, onPopperMouseLeave, onDocumentKeyDown, enableFlip = true, flipBehavior = 'flip', triggerRef, popperRef, animationDuration = 0, entryDelay = 0, exitDelay = 0, onHidden = () => { }, onHide = () => { }, onMount = () => { }, onShow = () => { }, onShown = () => { }, preventOverflow = false }) => {
    var _a;
    const [triggerElement, setTriggerElement] = consume_shared_module_default_react_17_0_singleton_.useState(null);
    const [refElement, setRefElement] = consume_shared_module_default_react_17_0_singleton_.useState(null);
    const [popperElement, setPopperElement] = consume_shared_module_default_react_17_0_singleton_.useState(null);
    const [popperContent, setPopperContent] = consume_shared_module_default_react_17_0_singleton_.useState(null);
    const [ready, setReady] = consume_shared_module_default_react_17_0_singleton_.useState(false);
    const [opacity, setOpacity] = consume_shared_module_default_react_17_0_singleton_.useState(0);
    const [internalIsVisible, setInternalIsVisible] = consume_shared_module_default_react_17_0_singleton_.useState(isVisible);
    const transitionTimerRef = consume_shared_module_default_react_17_0_singleton_.useRef(null);
    const showTimerRef = consume_shared_module_default_react_17_0_singleton_.useRef(null);
    const hideTimerRef = consume_shared_module_default_react_17_0_singleton_.useRef(null);
    const prevExitDelayRef = consume_shared_module_default_react_17_0_singleton_.useRef();
    ...
    const languageDirection = (0,util/* getLanguageDirection */.iJ)(triggerParent);
    const internalPosition = consume_shared_module_default_react_17_0_singleton_.useMemo(() => {
    ...
    const onDocumentClickCallback = consume_shared_module_default_react_17_0_singleton_.useCallback((event) => onDocumentClick(event, refOrTrigger, popperElement), [showPopper, triggerElement, refElement, popperElement, onDocumentClick]);
    consume_shared_module_default_react_17_0_singleton_.useEffect(() => {
        setReady(true);
        onMount();
    }, []);
    ...
    consume_shared_module_default_react_17_0_singleton_.useEffect(() => () => {
        (0,util/* clearTimeouts */.qb)([transitionTimerRef, hideTimerRef, showTimerRef]);
    }, []);
    consume_shared_module_default_react_17_0_singleton_.useEffect(() => {
        if (triggerRef) {
    ...
    const getPlacementMemo = consume_shared_module_default_react_17_0_singleton_.useMemo(getPlacement, [direction, internalPosition, placement]);
    const getOppositePlacementMemo = consume_shared_module_default_react_17_0_singleton_.useMemo(() => Popper_getOppositePlacement(getPlacement()), [direction, internalPosition, placement]);
    const widthMods = consume_shared_module_default_react_17_0_singleton_.useMemo(() => ({
        name: 'widthMods',
    ...
    consume_shared_module_default_react_17_0_singleton_.useEffect(() => {
        if (prevExitDelayRef.current < exitDelay) {
            (0,util/* clearTimeouts */.qb)([transitionTimerRef, hideTimerRef]);
    ...
    const hide = () => {
        onHide();
        (0,util/* clearTimeouts */.qb)([showTimerRef]);
        hideTimerRef.current = setTimeout(() => {
            setOpacity(0);
            transitionTimerRef.current = setTimeout(() => {
                setInternalIsVisible(false);
    ...
    const options = Object.assign({ className: (0,esm/* css */.A)(popper.props && popper.props.className, positionModifiers && modifierFromPopperPosition()), style: Object.assign(Object.assign(Object.assign({}, ((popper.props && popper.props.style) || {})), popperStyles.popper), { zIndex,
            opacity, transition: getOpacityTransition(animationDuration) }) }, attributes.popper);
    const getMenuWithPopper = () => {
        const localPopper = consume_shared_module_default_react_17_0_singleton_.cloneElement(popper, options);
        return popperRef ? (localPopper) : (consume_shared_module_default_react_17_0_singleton_.createElement("div", { style: { display: 'contents' }, ref: (node) => setPopperElement(node === null || node === void 0 ? void 0 : node.firstElementChild) }, localPopper));
    };
    const getPopper = () => {
        if (appendTo === 'inline') {
            ...
            return react_dom.createPortal(getMenuWithPopper(), target);
        }
    };
    return (consume_shared_module_default_react_17_0_singleton_.createElement(consume_shared_module_default_react_17_0_singleton_.Fragment, null,
        !triggerRef && trigger && consume_shared_module_default_react_17_0_singleton_.isValidElement(trigger) && (consume_shared_module_default_react_17_0_singleton_.createElement("div", { style: { display: 'contents' }, ref: (node) => setTriggerElement(node === null || node === void 0 ? void 0 : node.firstElementChild) }, trigger)),
        triggerRef && trigger && consume_shared_module_default_react_17_0_singleton_.isValidElement(trigger) && trigger,
 ...
 */
const useIsomorphicLayoutEffect = _util__WEBPACK_IMPORTED_MODULE_1__/* .canUseDOM */ .Sw ? react__WEBPACK_IMPORTED_MODULE_0__.useLayoutEffect : react__WEBPACK_IMPORTED_MODULE_0__.useEffect;
...
//# sourceMappingURL=vendors-node_modules_patternfly_react-core_dist_esm_components_Button_Button_js-node_modules_-6a1cc2.chunk.js.map
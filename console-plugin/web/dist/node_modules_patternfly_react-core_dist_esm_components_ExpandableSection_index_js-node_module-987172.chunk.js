"use strict";
(self["webpackChunkvcf_migration_console"] = self["webpackChunkvcf_migration_console"] || []).push([["node_modules_object-assign_index_js-_320c0","node_modules_object-assign_index_js-_320c1","node_modules_object-assign_index_js-_320c2","node_modules_object-assign_index_js-_320c3","node_modules_patternfly_react-core_dist_esm_components_ExpandableSection_index_js","node_modules_patternfly_react-core_dist_esm_components_ExpandableSection_index_js-node_module-987172"],{
...
/* harmony default export */ const expandable_section = ({
...
class ExpandableSection extends consume_shared_module_default_react_17_0_singleton_.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        if (this.props.variant === ExpandableSectionVariant.truncate) {
            ...
            this.observer = (0,resizeObserver/* getResizeObserver */.N)(expandableContent, this.handleResize, false);
    ...
    render() {
        ...
        truncateMaxLines } = _a, props = (0,tslib_es6/* __rest */.Tt)(_a, ["onToggle", "isActive", "className", "toggleText", "toggleTextExpanded", "toggleTextCollapsed", "toggleContent", "children", "isExpanded", "isDetached", "displaySize", "isWidthLimited", "isIndented", "contentId", "toggleId", "variant", "truncateMaxLines"]);
        ...
        const uniqueContentId = contentId || (0,util/* getUniqueId */.LP)('expandable-section-content');
        const uniqueToggleId = toggleId || (0,util/* getUniqueId */.LP)('expandable-section-toggle');
        // uncontrolled
        if (isExpanded === undefined) {
            propOrStateIsExpanded = this.state.isExpanded;
            onToggle = (event, isOpen) => {
                this.setState({ isExpanded: isOpen }, () => onToggleProp === null || onToggleProp === void 0 ? void 0 : onToggleProp(event, this.state.isExpanded));
            };
        }
        const computedToggleText = this.calculateToggleText(toggleText, toggleTextExpanded, toggleTextCollapsed, propOrStateIsExpanded);
        const expandableToggle = !isDetached && (consume_shared_module_default_react_17_0_singleton_.createElement("button", { className: (0,esm/* css */.A)(expandable_section.expandableSectionToggle), type: "button", "aria-expanded": propOrStateIsExpanded, "aria-controls": uniqueContentId, id: uniqueToggleId, onClick: (event) => onToggle === null || onToggle === void 0 ? void 0 : onToggle(event, !propOrStateIsExpanded) },
            variant !== ExpandableSectionVariant.truncate && (consume_shared_module_default_react_17_0_singleton_.createElement("span", { className: (0,esm/* css */.A)(expandable_section.expandableSectionToggleIcon) },
                consume_shared_module_default_react_17_0_singleton_.createElement(angle_right_icon/* default */.Ay, { "aria-hidden": true }))),
            consume_shared_module_default_react_17_0_singleton_.createElement("span", { className: (0,esm/* css */.A)(expandable_section.expandableSectionToggleText) }, toggleContent || computedToggleText)));
        return (consume_shared_module_default_react_17_0_singleton_.createElement("div", Object.assign({ className: (0,esm/* css */.A)(expandable_section.expandableSection, propOrStateIsExpanded && expandable_section.modifiers.expanded, isActive && expandable_section.modifiers.active, isDetached && expandable_section.modifiers.detached, displaySize === 'lg' && expandable_section.modifiers.displayLg, isWidthLimited && expandable_section.modifiers.limitWidth, isIndented && expandable_section.modifiers.indented, variant === ExpandableSectionVariant.truncate && expandable_section.modifiers.truncate, className) }, props),
            variant === ExpandableSectionVariant.default && expandableToggle,
            consume_shared_module_default_react_17_0_singleton_.createElement("div", { ref: this.expandableContentRef, className: (0,esm/* css */.A)(expandable_section.expandableSectionContent), hidden: variant !== ExpandableSectionVariant.truncate && !propOrStateIsExpanded, id: uniqueContentId, "aria-labelledby": uniqueToggleId, role: "region" }, children),
...
const ExpandableSectionToggle = (_a) => {
    var { children, className = '', isExpanded = false, onToggle, contentId, toggleId, direction = 'down', hasTruncatedContent = false } = _a, props = (0,tslib_es6/* __rest */.Tt)(_a, ["children", "className", "isExpanded", "onToggle", "contentId", "toggleId", "direction", "hasTruncatedContent"]);
    return (consume_shared_module_default_react_17_0_singleton_.createElement("div", Object.assign({ className: (0,esm/* css */.A)(expandable_section.expandableSection, isExpanded && expandable_section.modifiers.expanded, expandable_section.modifiers.detached, hasTruncatedContent && expandable_section.modifiers.truncate, className) }, props),
        consume_shared_module_default_react_17_0_singleton_.createElement("button", { className: (0,esm/* css */.A)(expandable_section.expandableSectionToggle), type: "button", "aria-expanded": isExpanded, "aria-controls": contentId, onClick: () => onToggle(!isExpanded), id: toggleId },
            !hasTruncatedContent && (consume_shared_module_default_react_17_0_singleton_.createElement("span", { className: (0,esm/* css */.A)(expandable_section.expandableSectionToggleIcon, isExpanded && direction === 'up' && expandable_section.modifiers.expandTop) },
                consume_shared_module_default_react_17_0_singleton_.createElement(angle_right_icon/* default */.Ay, { "aria-hidden": true }))),
            consume_shared_module_default_react_17_0_singleton_.createElement("span", { className: (0,esm/* css */.A)(expandable_section.expandableSectionToggleText) }, children))));
};
...
//# sourceMappingURL=node_modules_patternfly_react-core_dist_esm_components_ExpandableSection_index_js-node_module-987172.chunk.js.map
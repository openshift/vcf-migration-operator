...
const KeyboardHandler_1 = require('@patternfly/react-core/dist/js/helpers/KeyboardHandler');
...
const TableBase = (_a) => {
    ...
    React.useEffect(() => {
        ...
        if (tableRef && tableRef.current && tableRef.current.classList.contains('pf-m-tree-view')) {
            ...
            tbody && (0, KeyboardHandler_1.setTabIndex)(Array.from(tbody.querySelectorAll('button, a, input')));
        }
    ...
    const ouiaProps = (0, ouia_1.useOUIAProps)('Table', ouiaId, ouiaSafe);
    ...
    const handleKeys = (event) => {
        ...
        (0, KeyboardHandler_1.handleArrows)(event, rows, (element) => element === activeElement.closest('tr'), getFocusableElement, ['button', 'input', 'a'], undefined, false, true, false);
    };

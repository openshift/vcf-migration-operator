...
const TaskNodeInner = observer((_a) => {
    var _b, _c, _d;
    var { element, className, statusIconSize = STATUS_ICON_SIZE, scaleNode, badgePopoverProps, toolTip, toolTipProps, disableTooltip = false, hasWhenExpression = false, whenSize = 0, whenOffset = 0 } = _a, rest = __rest(_a, ["element", "className", "statusIconSize", "scaleNode", "badgePopoverProps", "toolTip", "toolTipProps", "disableTooltip", "hasWhenExpression", "whenSize", "whenOffset"]);

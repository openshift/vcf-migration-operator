...
const angle_right_icon_1 = tslib_1.__importDefault(require("@patternfly/react-icons/dist/esm/icons/angle-right-icon"));
const ContextSubMenuItem = (_a) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(react_core_1.DropdownItem, Object.assign({}, other, { className: (0, react_styles_1.css)(topology_components_1.default.topologyContextSubMenu), ref: nodeRef, 
        ...
        React.createElement(Popper_1.default, { open: open, placement: "right-start", closeOnEsc: true, closeOnOutsideClick: true, onRequestClose: (e) => {
            ...
            React.createElement("div", { ref: subMenuRef, role: "presentation", className: "pf-v5-c-dropdown pf-m-expanded", onMouseLeave: (e) => {
                ...
                React.createElement(react_core_1.Dropdown, { toggle: () => React.createElement(React.Fragment, null), className: (0, react_styles_1.css)(topology_components_1.default.topologyContextMenuCDropdownMenu) }, children)))));
};

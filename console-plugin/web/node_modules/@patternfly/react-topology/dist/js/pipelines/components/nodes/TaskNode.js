...
const TaskNodeInner = (0, mobx_exports_1.observer)((_a) => {
    var _b, _c, _d;
    var { element, className, statusIconSize = STATUS_ICON_SIZE, scaleNode, badgePopoverProps, toolTip, toolTipProps, disableTooltip = false, hasWhenExpression = false, whenSize = 0, whenOffset = 0 } = _a, rest = tslib_1.__rest(_a, ["element", "className", "statusIconSize", "scaleNode", "badgePopoverProps", "toolTip", "toolTipProps", "disableTooltip", "hasWhenExpression", "whenSize", "whenOffset"]);
...
const TaskNode = (_a) => {
    var { element, paddingX = 8, paddingY = 8, statusIconSize = STATUS_ICON_SIZE, showStatusState = true, hiddenDetailsShownStatuses = [types_2.RunStatus.Failed, types_2.RunStatus.FailedToStart, types_2.RunStatus.Cancelled], badgeClassName = topology_pipelines_1.default.topologyPipelinesPillBadge, taskIconPadding = 4, truncateLength = 14, disableTooltip = false, hasWhenExpression = false, whenSize = 0, whenOffset = 0 } = _a, rest = tslib_1.__rest(_a, ["element", "paddingX", "paddingY", "statusIconSize", "showStatusState", "hiddenDetailsShownStatuses", "badgeClassName", "taskIconPadding", "truncateLength", "disableTooltip", "hasWhenExpression", "whenSize", "whenOffset"]);
    if (!(0, types_1.isNode)(element)) {
        throw new Error('TaskNode must be used only on Node elements');
    }
    return (React.createElement(TaskNodeInner, Object.assign({ element: element, paddingX: paddingX, paddingY: paddingY, statusIconSize: statusIconSize, showStatusState: showStatusState, hiddenDetailsShownStatuses: hiddenDetailsShownStatuses, badgeClassName: badgeClassName, taskIconPadding: taskIconPadding, truncateLength: truncateLength, disableTooltip: disableTooltip, hasWhenExpression: hasWhenExpression, whenSize: whenSize, whenOffset: whenOffset }, rest)));
};

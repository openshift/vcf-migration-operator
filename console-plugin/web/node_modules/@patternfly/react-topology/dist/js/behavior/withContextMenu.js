...
const withContextMenu = (actions, container, className, atPoint = true, waitElement = React.createElement(react_core_1.Spinner, { className: "pf-v5-u-mx-md", size: "md" })) => (WrappedComponent) => {
